...
export const mapEntity1 = <T extends Entity1Document | Error | undefined | null>(
  entity1: T,
): T extends null | undefined ? null : Entity1 => {
...
export const mapEntity2 = <T extends Entity2Document | undefined | null | Error>(
  entity2: T,
): T extends null | undefined ? null : Entity2 => {
